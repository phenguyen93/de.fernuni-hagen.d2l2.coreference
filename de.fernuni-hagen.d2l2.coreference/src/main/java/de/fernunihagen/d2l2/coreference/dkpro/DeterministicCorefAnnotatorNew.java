...
public class DeterministicCorefAnnotatorNew implements Annotator  {

  /** A logger for this class */
  private static final Redwood.RedwoodChannels log = Redwood.channels(DeterministicCorefAnnotatorNew.class);
  ...
  public DeterministicCorefAnnotatorNew(Properties props) {
    try {
